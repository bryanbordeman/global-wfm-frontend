...
import { setMinutes, setSeconds, startOfHour } from 'date-fns';
...
export default function AddWorksegmentForm(props) {
    ...
    const initialFormValues = {
        ...
        is_approved: false,
        date: new Date(),
        startTime: roundToNearestQuarterHour(new Date()),
        endTime: roundToNearestQuarterHour(new Date()),
        lunch: true,
        travel: 0,
        notes: ''
    };
    ...
    function roundToNearestQuarterHour(date) {
        ...
        return setSeconds(setMinutes(start, quarters * 15), 0);
    }
                    ...
                    <Stack direction="column" spacing={2}>
                        ...
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                            <MobileTimePicker
                                ...
                                onChange={(time) => {
                                    const roundedTime = roundToNearestQuarterHour(time);
                                    setValues({...values, startTime: roundedTime});
                                }}
                        ...
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                            <MobileTimePicker
                                ...
                                onChange={(time) => {
                                    const roundedTime = roundToNearestQuarterHour(time);
                                    setValues({...values, endTime: roundedTime});
                                }}
